...
import top.bluesword.web.laboratory.infrastructure.activiti.ProcessDefinitionService;
...
public class ProcessDefinitionTest {
	...
	public void deploy() {
		...
		Deployment deploy = repositoryService.createDeployment().addBpmnModel("bluesword.bpmn", bpmnModel)
			.deploy();
		System.out.println(JSON.toJSONString(deploy));
	}
